Bird = {};
Bird.ZipModelLoader = function ( manager ) {
    ...
    this.textureSharedMap = {};
    this.materialSharedMap = {};

};

Bird.ZipModelLoader.prototype = {

    constructor: Bird.ZipModelLoader,
    ...
    parse: function ( json, data, onLoad ) {
        ...
        if ( json.metadata && json.metadata.fileVersion ) {

            this.version = json.metadata.fileVersion;
        ...
        if ( data !== null ) {
            ...
            if ( this.version > 0 ) {
                ...
                buffers = this.parseBuffers( json.buffers, data );

                geometries = this.parseGeometries( json.geometries, buffers );
    ...
    parseBuffers: function ( json, bufferdata ) {
        ...
        if ( json !== undefined ) {
            ...
            for ( var i in json ) {
                ...
                var bufferInfo = json[ i ];
                buffers[ bufferInfo.id ] = new THREE.InterleavedBuffer( new Float32Array( bufferdata, bufferInfo.offset, bufferInfo.stride * bufferInfo.count ),  bufferInfo.stride );
            ...
            for ( var i = 0, l = json.length; i < l; i ++ ) {
                ...
                switch ( data.type ) {
                    ...
                    case 'BufferGeometry':
                        ...
                        geometry = this.parseBufferGeometry( data, accessors, bufferdata );
        ...
        if ( json !== undefined ) {
            ...
            for ( var i = 0, l = json.length; i < l; i ++ ) {
                ...
                if ( this.textureSharedMap && this.textureSharedMap[data.uuid] ) {
                    ...
                    // 如果是来自于动态设置的renderTarget，则创建一个缺省的Texture
                    if ( data.fromRenderTarget ) {

                        texture = new THREE.Texture();
                        texture.uuid = data.uuid;
                        texture.fromRenderTarget = true;
        ...
        return function ( data, geometries, materials ) {
            ...
            if ( data.children !== undefined ) {
                ...
                for ( var index in data.children ) {
                    ...
                    object.add( this.parseObject( data.children[ index ], geometries, materials ) );
    ...
    parseBufferGeometry : (function () {

        function getArrayBuffer ( attribute, accessors, bufferdata ) {
            ...
            return new Float32Array( subArray, 0, bufferInfo.count );

        }

        return function ( json, accessors, bufferdata ) {
...
//			'Uint8ClampedArray': Uint8ClampedArray,
            ...
            if ( this.version > 0 ) {
                ...
                for ( key in attributes ) {
                    ...
                    geometry.addAttribute( key, new THREE.InterleavedBufferAttribute( accessors[ attribute.buffer ], attribute.itemSize, attribute.offset ) );
                ...
                for ( key in attributes ) {
                    ...
                    geometry.addAttribute( key, new THREE.BufferAttribute( getArrayBuffer( attribute, accessors, bufferdata ), attribute.itemSize ) );
